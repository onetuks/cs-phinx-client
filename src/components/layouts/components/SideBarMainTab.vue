...
import { SideBarMainTab } from "@/components/layouts/types/SideBarTab";
...
const isTabFocused = (): boolean => route.path.includes(props.tabType.path);

const moveToPage = () => router.push(props.tabType.path);
</script>
